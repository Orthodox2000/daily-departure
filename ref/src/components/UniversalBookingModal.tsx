...
import { X, Plane, Hotel, Palmtree, FileCheck, CheckCircle2, ShieldCheck, ArrowRight, Sparkles } from 'lucide-react';
import { POPULAR_DESTINATIONS, HOLIDAY_PACKAGES, HOTELS_DATA, VISA_SERVICES } from '../data/travelData';
